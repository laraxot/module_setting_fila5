---
title: "Code redundancy audit — Setting"
type: source
status: draft
...
| Voce | Valore |
|---|---:|
| File PHP analizzati | 31 |
| Rischio ridondanza | medium |
| Basename duplicati locali | 0 |
| Hash normalizzati duplicati cross-owner | 1 |
| Class/trait/interface name ripetuti nel monorepo | 7 |
